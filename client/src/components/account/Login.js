...
//& > div means apply css to all child whihc are div
                ...
                <Image src={imageURL} />
                {
                    account === 'login' ?
                        ...
                        <Wrapper>
                            ...
                            <Text style={{ textAlign: 'center' }}>OR</Text>
                            <LoginButton onClick={() => toggleSignup()} variant="contained">Aldready have an account</LoginButton>
                        </Wrapper>
                }
            </Box>
        </Component>
